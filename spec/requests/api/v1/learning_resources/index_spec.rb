...
RSpec.describe 'Learning Resource', type: :request do
  describe 'get a learning resource by country' do
    it 'can return a serialized learning resource' do
      VCR.use_cassette("Learning_Resource/get_a_learning_resource_by_country/can_return_a_serialized_learning_resource", match_requests_on: [:path]) do
        ...
        expect(learning_resource[:attributes][:images][0][:url]).to eq("https://images.unsplash.com/photo-1540611025311-01df3cef54b5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0ODU0Njl8MHwxfHNlYXJjaHwxfHxsYW9zfGVufDB8fHx8MTY5MTUxMDM1OXww&ixlib=rb-4.0.3&q=80&w=1080")
    ...
    it 'will return empty video and images if none are found' do
      VCR.use_cassette("Learning_Resource/get_a_learning_resource_by_country/will_return_empty_video_and_images_if_none_are_found", match_requests_on: [:path]) do
